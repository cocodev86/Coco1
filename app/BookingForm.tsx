    ...
    <form ref={formRef} className="booking-form" onSubmit={handleSubmit} noValidate>
      ...
      <section className={styles.panel} hidden={step !== 1} aria-labelledby="booking-step-one-title">
        ...
        <div className="form-grid">
          ...
          <label className={styles.field}><span>Phone</span><input name="phone" type="tel" maxLength={30} autoComplete="tel" /><small className={styles.hint}>Optional—include area code if you prefer a call or text.</small></label>
